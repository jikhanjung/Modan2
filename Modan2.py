...
class ModanMainWindow(QMainWindow):
    ...
    def read_settings(self):
        ...
        # Latin renders in serif; the first installed CJK font follows so Korean
        # labels fall back per-glyph instead of drawing tofu. See the helper and
        # devlog 241 for why this must be an explicit list of installed names.
