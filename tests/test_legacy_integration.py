...
class TestObjectDialogEdgeCases:
    ...
    def sample_dataset_for_edge_cases(self):
        ...
        dataset = MdModel.MdDataset.create(dataset_name="EdgeCaseDataset", dimension=2, baseline_point_count=0)
        return dataset
...
class TestIntegrationRegressionTests:
    ...
    def test_dataset_creation_with_unicode_names(self, qtbot):
        ...
        for name in unicode_names:
            try:
                dataset = MdModel.MdDataset.create(dataset_name=name, dimension=2, baseline_point_count=0)
    ...
    def test_large_number_of_objects_in_dataset(self, qtbot):
        ...
        # Create dataset
        dataset = MdModel.MdDataset.create(dataset_name="LargeObjectDataset", dimension=2, baseline_point_count=0)

        # Create many objects
        object_count = 100
        for i in range(object_count):
            MdModel.MdObject.create(object_name=f"Object_{i:03d}", dataset=dataset)
