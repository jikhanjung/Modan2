...
# Create dataset
dataset = MdModel.MdDataset.create(dataset_name="Test Dataset", dimension=2, landmark_count=5)

# Create object with landmarks
obj = MdModel.MdObject.create(dataset=dataset, object_name="Test Object", sequence=1)
