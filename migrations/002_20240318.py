...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    class MdAnalysis(pw.Model):
        id = pw.AutoField()
        analysis_name = pw.CharField(max_length=255)
        analysis_desc = pw.CharField(max_length=255, null=True)
        dataset = pw.ForeignKeyField(column_name='dataset_id', field='id', model=migrator.orm['mddataset'], null=True)
        ...
        class Meta:
            table_name = "mdanalysis"


def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    """Write your rollback migrations here."""
    
    migrator.remove_model('mdanalysis')
