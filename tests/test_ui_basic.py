...
class TestDatasetSelection:
    ...
    def test_multiple_dataset_switch(self, qtbot, main_window, mock_database):
        ...
        dataset1 = MdModel.MdDataset.create(
            dataset_name="Dataset 1", dataset_desc="First dataset", dimension=2, landmark_count=5
        )

        dataset2 = MdModel.MdDataset.create(
            dataset_name="Dataset 2", dataset_desc="Second dataset", dimension=3, landmark_count=10
        )
...
class TestDragAndDrop:
    ...
    def test_drag_enter_event_accepts_urls(self, main_window):
        ...
        assert not main_window.acceptDrops()  # May be False by default
...
class TestUIResponsiveness:
    ...
    def test_table_updates_on_object_addition(self, qtbot, main_window, sample_dataset):
        ...
        # Initial row count
        main_window.tableView.model().rowCount() if main_window.tableView.model() else 0
